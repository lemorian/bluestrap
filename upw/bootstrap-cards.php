...
/**
 * Standard ultimate posts widget template for Bootstrap 4
 *
 * @version     2.0.0
 */
?>
...
<div class="card-deck">
  <?php if ($upw_query->have_posts()) : ?>
      ...
      <?php while ($upw_query->have_posts()) : $upw_query->the_post(); ?>
        ...
        <article class="card card-listings product-listings-card">
          ...
          <header>
            ...
            <?php if (current_theme_supports('post-thumbnails') && $instance['show_thumbnail'] && has_post_thumbnail()) : ?>
              ...
              <span class="Centerer"></span>
                <a href="<?php the_permalink(); ?>" rel="bookmark" class="card-img-top,Centered">
